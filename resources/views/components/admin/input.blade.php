...
<label {{ $attributes->merge(['class' => 'block']) }}>
    ...
    <input type="{{ $type }}" wire:model="{{ $model }}" class="mt-2 w-full rounded-md border border-white/10 bg-zinc-900 px-4 py-3 text-zinc-100 outline-none focus:ring-2 focus:ring-teal-400">
